...
void enemy2::update(sf::Vector2u windowSize)  /////need random weapon, armor, and etc. 
{
	rect.setPosition(rand_gen_ptp(632, 1928), rand_gen_ptp(56, 1383));
	weapon_class = rand_gen_0(4); weapon_rank = rand_gen_0(2);
...
void enemy2::updateMovement(sf::Vector2f charPos, sf::Vector2f enemyPos, sf::Vector2u windowSize)
{
	charX = (int)charPos.x;
	charY = (int)charPos.y;
