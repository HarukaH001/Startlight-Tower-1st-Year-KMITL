...
void enemy::update(sf::Vector2u windowSize)  /////need random weapon, armor, and etc. 
{
...
void enemy::updateMovement(sf::Vector2f charPos, sf::Vector2f enemyPos, sf::Vector2u windowSize)
{
	charX = (int)charPos.x;
	charY = (int)charPos.y;
